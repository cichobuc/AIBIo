  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 px-4 py-2.5 border-b">
        ...
        <span className="text-xs font-medium">Write Model File</span>
        <Badge variant="outline" className="text-[10px] h-4 px-1.5 ml-1">
          {layer}
        </Badge>
        <span className="font-mono text-xs text-primary ml-1">{modelName}.sql</span>
      ...
      <div className="flex items-center gap-2 px-4 py-2.5 border-t bg-card/80">
        <span className="text-xs text-muted-foreground flex-1">
          {isNew ? `${linesAdded} lines added · New file` : `~${linesAdded} lines added · ~${linesRemoved} lines removed`}
        </span>
